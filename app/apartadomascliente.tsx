...
export default function ApartadoMasClienteScreen() {
  ...
  // 🔥 ELIMINADO: pickImage() - Cambiar foto solo desde Editar Perfil
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              ...
              >
                ...
                <View style={styles.menuItemInfo}>
                  <Text style={styles.menuItemTextModern}>Configuración</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color="#999" />
              </TouchableOpacity>
            </View>
