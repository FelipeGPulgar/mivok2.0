...
export default function AlertasClienteScreen() {
  ...
  useEffect(() => {
    ...
    const loadAlerts = async () => {
      try {
        ...
        setCurrentUser(user);
        console.log('📢 Cargando alertas para Cliente:', user.id);
        ...
        unsubscribeMessages = chatFunctions.subscribeToAllMessages(user.id, async (newMessage: any) => {
          console.log('📢 Nuevo mensaje recibido en pantalla de alertas Cliente:', newMessage.id);
