...
export default function AlertasDJScreen() {
  ...
  useEffect(() => {
    ...
    const loadAlerts = async () => {
      try {
        ...
        setCurrentUser(user);
        console.log('📢 Cargando alertas para DJ:', user.id);
        ...
        unsubscribeMessages = chatFunctions.subscribeToAllMessages(user.id, async (newMessage: any) => {
          console.log('📢 Nuevo mensaje recibido en pantalla de alertas DJ:', newMessage.id);
